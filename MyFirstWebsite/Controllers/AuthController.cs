...
namespace MyFirstWebsite.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public ActionResult LogIn(LoginModel model)
        {
            ...
            //Checks whether the input is the same as those literals. Note: Never ever do this! 
            // This is just to demo the validation while we're not yet doing any database interaction
